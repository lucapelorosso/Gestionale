...
null,
(SELECT nationID FROM gestionale.nation where nation_name = 'Italia'),
(SELECT indirizzo.addressID FROM gestionale.address indirizzo WHERE indirizzo.city = 'Sesto San Giovanni' AND a_address = 'Giuseppe Rovani' AND indirizzo.a_number = '242')
);
COMMIT;
